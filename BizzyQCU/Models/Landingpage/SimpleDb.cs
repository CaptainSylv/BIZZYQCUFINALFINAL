...
namespace BizzyQCU.Models.Landingpage
{
    ...
    public class SimpleDb
    {
        ...
        public bool UpdateUserPassword(int userId, string currentPassword, string newPassword)
        {
            try
            {
                using (var conn = new MySqlConnection(connectionString))
        ...
        public bool SaveEnterpriseProfileData(int userId, string storeName, string gcashNumber, string email, string managerName, string managerStudentId, string managerContact, string section, string storeLogoPath, byte[] qrBytes)
        {
            try
            {
                using (var conn = new MySqlConnection(connectionString))
